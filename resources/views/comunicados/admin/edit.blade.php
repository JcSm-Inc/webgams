...
<div class="w-full static m-2 shadow-2xl rounded my-24">
    {!! Form::model($comunicado,['route' => ['comunicados.update',$comunicado],'method'=>'PUT','enctype'=>'multipart/form-data']) !!}
    @csrf
    <div class="top h-64 w-full bg-blue-600 overflow-hidden relative" >
      <img id="blah" src="{{asset($comunicado->ARCHIVO)}}" alt="" class="bg w-full h-full object-fill object-center absolute z-0">
